...
def crear_paladin(jugador):
    return Pieza(
        nombre="Paladin", jugador=jugador, hp=30, atk=5, agi=5.2,
...
def crear_mago(jugador):
    return Pieza(
        nombre="Mago", jugador=jugador, hp=12, atk=7, agi=4.8,
...
def crear_destructor(jugador):
    return Pieza(
        nombre="Destructor", jugador=jugador, hp=50, atk=10, agi=4.4,
